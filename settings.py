...
ROOT_URLCONF = 'advances_in_artificial_intelligence.urls'
...
WSGI_APPLICATION = 'advances_in_artificial_intelligence.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'advances_in_artificial_intelligence.remote_user_detection_accuracy',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
