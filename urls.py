"""advances_in_artificial_intelligence URL Configuration
...
from advances_in_artificial_intelligence import settings
...
urlpatterns = [
    ...
    url(r'^Predict_early_detection_of_human_diseases/$', remoteuser.Predict_early_detection_of_human_diseases, name="Predict_early_detection_of_human_diseases"),
    ...
    url(r'^View_All_Uploaded_Datasets/$',serviceprovider.View_All_Uploaded_Datasets, name="View_All_Uploaded_Datasets"),
    url(r'^Upload_Datasets/$', serviceprovider.Upload_Datasets, name="Upload_Datasets"),
    url(r'^View_Prediction_Of_early_detection_of_human_Ratio/$', serviceprovider.View_Prediction_Of_early_detection_of_human_Ratio, name="View_Prediction_Of_early_detection_of_human_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_early_detection_of_human_diseases/$', serviceprovider.View_Prediction_Of_early_detection_of_human_diseases, name="View_Prediction_Of_early_detection_of_human_diseases"),
